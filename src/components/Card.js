...
const Card = ({ taskObj, index ,deleteTask,updateListArray}) => {
    ...
    // const color = colors[index % colors.length] || { primaryColor: "#000", secondaryColor: "#fff" }; // Fallback colors

    return (
        <div className="card-wrapper mr-10" key={index}>
            ...
            <div className="task-holder">
                ...
                <p className="mt-1">{taskObj.Description}</p>
